...
CREATE TABLE IF NOT EXISTS public.convoys (
  ...
  vehicle_theme text NOT NULL DEFAULT 'Kerala & Tamil Nadu Buses (All Welcome)',
  server_region text NOT NULL DEFAULT 'India , Chennai',
  room_name text NOT NULL DEFAULT 'bussid_ventures',
  room_password text DEFAULT '1111',
